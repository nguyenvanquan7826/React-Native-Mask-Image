...
public class MaskShapeImageView extends PorterImageView {
    ...
    public MaskShapeImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(context, attrs, 0);
    }

    public MaskShapeImageView(Context context, AttributeSet attrs, int defStyle) {
